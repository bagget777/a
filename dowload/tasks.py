...
def send_email(subject, body, to_email, attachment_path):
    ...
    msg['Subject'] = subject
    msg['From'] = 'bagget7777@gmail.com'  # Replace with your email address
    msg['To'] = to_email
    ...
    server.starttls()
    server.login('bagget7777@gmail.com', 'bayzak2005')  # Replace with your email address and password
